...
public class ServerLancherPanel extends JPanel implements ActionListener{
	...
	private static final String TEXT_BESIDE_TF_PORT = "Port:";
	private static final Point P_TEXT_WELCOME_MESSAGE = new Point(10, 20);
	private static final Point P_TEXT_BESIDE_TF_PORT = new Point(10, 50);
	
	private static final String NAME_BTN_LAUNCH = "Launch";
	private static final String NAME_BTN_END = "End";
	
	private static final Dimension DM_TF_PORT = new Dimension(40, 20);
	...
	private static final Point P_TF_PORT = new Point(50, 37);
	...
	private ServerLancherPanel(){
		...
		tfPort.setSize(DM_TF_PORT);
		tfPort.setLocation(P_TF_PORT);
		tfPort.setFocusable(true);
	...
	public void paintComponent(Graphics g){
		...
		g.drawString(TEXT_BESIDE_TF_PORT, P_TEXT_BESIDE_TF_PORT.x, P_TEXT_BESIDE_TF_PORT.y);
	}
